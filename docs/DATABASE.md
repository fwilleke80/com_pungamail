...
- `0.6.34.sql` — adds per-Newsletter `archive_visibility`; existing records inherit the conservative component default and therefore do not become public merely because the extension was updated.
