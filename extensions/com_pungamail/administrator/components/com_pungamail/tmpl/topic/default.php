...
<form action="<?php echo Route::_(AdministratorRoute::topics()); ?>" method="post" name="adminForm" id="adminForm">
	<div class="card"><div class="card-body">
		...
		<div class="mb-3"><label class="form-label" for="topic-ordering"><?php echo Text::_('JFIELD_ORDERING_LABEL'); ?></label><input class="form-control" type="number" id="topic-ordering" name="ordering" value="<?php echo (int) ($item->ordering ?? 0); ?>"></div>
