...
<?php else : ?>
	<form action="<?php echo Route::_('index.php?option=com_pungamail'); ?>" method="post" name="adminForm" id="adminForm" data-pm-unsaved-warning="1">
						...
						<fieldset>
							...
							<?php foreach ($this->topics as $topic) : ?>
								<div class="form-check">
									<input class="form-check-input pm-audience-topic" type="checkbox" name="topic_ids[]" value="<?php echo (int) $topic->id; ?>" id="topic-<?php echo (int) $topic->id; ?>" <?php echo in_array((int) $topic->id, $this->selectedTopicIds, true) ? 'checked' : ''; ?>>
									<label class="form-check-label" for="topic-<?php echo (int) $topic->id; ?>">
		...
		<?php echo HTMLHelper::_('uitab.addTab', 'pm-newsletter-tabs', 'pm-layout', Text::_('COM_PUNGAMAIL_TAB_LAYOUT')); ?>
		<div class="pt-3">
			<?php echo \Joomla\CMS\Layout\LayoutHelper::render(
				...
				[
					'item' => $item,
					'style' => $style,
					'prefix' => 'newsletter-layout',
					'help_key' => 'COM_PUNGAMAIL_LAYOUT_NEWSLETTER_HELP',
				],
		...
		<?php echo HTMLHelper::_('uitab.endTabSet'); ?>
			...
			<aside class="col-12 col-xl-3">
				...
				<?php if ($this->canEdit && $this->canSend) : ?>
				<div class="card mb-3">
