...
<div class="container-fluid">
	...
	<div class="card mb-3">
		...
		<div class="card-body p-0">
			<iframe title="<?php echo htmlspecialchars(Text::_('COM_PUNGAMAIL_HTML_PREVIEW'), ENT_QUOTES, 'UTF-8'); ?>" style="width:100%;height:700px;border:0;background:#fff" srcdoc="<?php echo htmlspecialchars($previewHtml, ENT_QUOTES, 'UTF-8'); ?>"></iframe>
		</div>
	</div>
	<div class="card">
