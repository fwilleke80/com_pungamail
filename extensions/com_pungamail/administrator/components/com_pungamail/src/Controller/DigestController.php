...
final class DigestController extends BaseController
{
	...
	private function readInput(): array
	{
		...
		return [
			...
			'content_order' => $input->post->getCmd('content_order', 'newest'),
			'max_items' => max(0, $input->post->getInt('max_items', 0)),
			'minimum_items' => max(0, $input->post->getInt('minimum_items', 0)),
