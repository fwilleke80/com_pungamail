...
CREATE TABLE IF NOT EXISTS `#__pungamail_newsletters` (
  ...
  `reply_to_email` VARCHAR(320) NULL,
  `reply_to_name` VARCHAR(255) NULL,
  `campaign_scope` VARCHAR(12) NOT NULL DEFAULT 'inherit',
...
CREATE TABLE IF NOT EXISTS `#__pungamail_digests` (
  ...
  `first_run_cutoff_mode` VARCHAR(16) NOT NULL DEFAULT 'recurrence',
  `first_run_lookback_hours` INT UNSIGNED NOT NULL DEFAULT 168,
