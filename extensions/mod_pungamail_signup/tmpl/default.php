...
<div class="pungamail-signup">
	...
	<?php if (!$pungamail['logged_in']) : ?>
		<form action="<?php echo Route::_('index.php?option=com_pungamail&task=subscription.request'); ?>" method="post">
			...
			<?php elseif ($topics !== []) : ?>
				...
				<div class="form-text"><?php echo Text::_('MOD_PUNGAMAIL_SIGNUP_TOPIC_NONE_HELP'); ?></div>
				</fieldset>
			<?php else : ?>
				<p class="form-text"><?php echo Text::_('MOD_PUNGAMAIL_SIGNUP_TOPIC_NONE_HELP'); ?></p>
			<?php endif; ?>
	...
	<?php else : ?>
		...
		<?php if ($pungamail['subscribed']) : ?>
			...
			<p class="form-text"><?php echo Text::_('MOD_PUNGAMAIL_SIGNUP_MASTER_HELP'); ?></p>
